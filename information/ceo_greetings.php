                ...
                <div class="container">
                        ...
                        <ul>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    <li><a href="#">회사개요</a></li>
                                    <li><a href="/information/ceo_greetings.php">CEO 인사말</a></li>
                                    <li><a href="#">회사연혁</a></li>
                                    <li><a href="#">운영조직</a></li>
                    ...
                    <div class="row geumdo-ceo">
                        <div class="col-xs-12 col-md-12 col-lg-6">
                            희 금도건설은 ‘열정적인 자세, 지속적인 혁신, 실용적인 사고’ 라는 경영이념 아래 가치경영과 혁신경영을 바탕에 두고 완벽한 품질관리를 통해 고객의 신뢰에 보답하고자 고객 만족을 최우선 목표로 끊임없이 정진해 왔으며 국가 산업 발전의 초석이 되는 토목부분은 물론, 국민생활의 수준을 보다 향상시키는 건축분야에서도 주도적인 역할을 하고 있습니다.
                        </div>
                        <div class="col-xs-12 col-md-12 col-lg-6">
                            ...
                            감사합니다.
                            <p class="ceo">금도건설 회장 <img src="/assets/images/information/ceo.gif" alt="회장 황 수 원"></p>
                        </div>
                    </div>
                </div>
            </div>
